...
{
  "\"end of file\"", "error", "\"invalid token\"", "SINT", "SEMI",
  "ASSIGNOP", "IDENTIFIER", "INTCONST", "$accept", "program", "decl",
  "type", "aid", "tim", "assign", YY_NULLPTR
};
