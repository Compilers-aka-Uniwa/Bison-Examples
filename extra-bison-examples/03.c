...
#line 24 "03.y"
                         { printf("\t[BISON] Result for addition: %d\n", yyvsp[-2]+yyvsp[-1]); yyval = yyvsp[-2] + yyvsp[-1]; }
#line 1125 "03.c"
    break;

  case 6: /* expr: expr expr "*"  */
#line 25 "03.y"
                         { printf("\t[BISON] Result for multiplication: %d\n", yyvsp[-2]*yyvsp[-1]); yyval = yyvsp[-2] * yyvsp[-1]; }
#line 1131 "03.c"
    break;

  case 7: /* expr: expr expr "<"  */
#line 26 "03.y"
                         { printf("\t[BISON] Is %d less than %d ?\n", yyvsp[-2], yyvsp[-1]); }
#line 1137 "03.c"
    break;

  case 8: /* expr: expr expr ">="  */
#line 27 "03.y"
                         { printf("\t[BISON] Is %d greater than or equal to %d ?\n", yyvsp[-2], yyvsp[-1]); }
#line 1143 "03.c"
    break;

  case 9: /* expr: expr expr ">"  */
#line 28 "03.y"
                         { printf("\t[BISON] Is %d greater than %d ?\n", yyvsp[-2], yyvsp[-1]); }
#line 1149 "03.c"
    break;
